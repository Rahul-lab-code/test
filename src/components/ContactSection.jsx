...
import { User, Mail, MessageSquare } from "react-feather"; // Import your icons
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        const response = await fetch("https://api.staticforms.xyz/submit", {
          ...
          body: JSON.stringify({
            accessKey: "99110c63-be0a-41dd-b171-b748fdd0b713", // Replace with your StaticForms access key
            name: formData.name,
